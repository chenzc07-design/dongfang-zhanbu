    ...
    <div className="min-h-screen bg-[#faf8f4] flex items-center justify-center px-4 relative">
      ...
      <div className="relative z-10 max-w-md w-full text-center">
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="w-12 h-px bg-gradient-to-r from-transparent to-[rgba(184,134,11,0.4)]" />
          <span className="text-[#b8860b] text-xs tracking-[0.3em] uppercase font-medium">
            {status === 'success' ? '✦ Complete ✦' : '✦ Processing ✦'}
          </span>
          <div className="w-12 h-px bg-gradient-to-r from-[rgba(184,134,11,0.4)] to-transparent" />
        </div>
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-[#6b5e4a] mb-8">
              Thank you for your purchase. Master Gao Wei will personally review your chart and your report will be delivered to your email within <strong>24 hours</strong>.
            </p>
        ...
        {status === 'error' && (
          <>
            ...
            <p className="text-[#9b2d30] mb-8">{errorMsg}</p>
        ...
        <p className="text-xs text-[#9b8e7c] mt-8">
          Didn&apos;t receive the email within 24 hours? Check your spam folder or{' '}
          <a href="mailto:support@dongfangdivination.com" className="text-[#b8860b] underline">contact support</a>.
        </p>

        {orderId && (
          <p className="text-xs text-[#9b8e7c] mt-4">
