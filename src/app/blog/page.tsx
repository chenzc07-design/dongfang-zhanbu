...
const categoryColors: Record<string, string> = {
  'BaZi Basics': 'text-[#b8860b] bg-[rgba(184,134,11,0.08)] border-[rgba(184,134,11,0.15)]',
  ...
  'Career & Wealth': 'text-[#b8860b] bg-[rgba(184,134,11,0.08)] border-[rgba(184,134,11,0.15)]',
  ...
  'BaZi Astrology': 'text-[#b8860b] bg-[rgba(184,134,11,0.08)] border-[rgba(184,134,11,0.15)]',
    ...
    <div className="min-h-screen bg-[#faf8f4] text-[#2c2416]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-14">
          <Link href="/" className="inline-block text-[#9b8e7c] hover:text-[#b8860b] text-sm mb-6 transition-colors">
            ← Back to Dongfang Divination
          </Link>
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-10 h-px bg-gradient-to-r from-transparent to-[rgba(184,134,11,0.3)]" />
            <span className="text-[#b8860b] text-xs tracking-[0.3em] uppercase font-medium">Knowledge Hub</span>
            <div className="w-10 h-px bg-gradient-to-r from-[rgba(184,134,11,0.3)] to-transparent" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-[#2c2416] mb-4">
            Ancient Wisdom Insights
          </h1>
          <p className="text-[#6b5e4a] text-base max-w-xl mx-auto leading-relaxed">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          <div className="flex-1">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-[#2c2416] group-hover:text-[#b8860b] transition-colors mb-3">
              {post.title}
            </h2>
        ...
        <div className="mt-4 flex items-center gap-2 text-[#b8860b] text-xs opacity-0 group-hover:opacity-100 transition-opacity tracking-wide uppercase">
          Read article
